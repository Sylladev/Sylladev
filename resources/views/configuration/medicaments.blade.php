             ...
             <div class="row">
                   <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Nouvelle categorie</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_categorieMedicament') }}">
                                            {{ csrf_field() }}
                ...
                <div class="col-lg-6 col-md-3">
                   ...
                   <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Nouveau médicament</header>
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_medicament') }}">
                                            {{ csrf_field() }}
                                            <div class="col-lg-6 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Groupe</label>
                                     <select class="form-control" id="typeini" name="idCategorieMedicament" >
                                      @foreach($categ as $key => $catege)
                                         <option value="{{ $catege->idCategorieMedicament }}">{{ $catege->description }}</option>
                                       @endforeach
							                       </select>
                                            </div>

                                            <div class="col-lg-6 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Nom/Description</label>
                                              <input type="text" name="description" required class="form-control">
                                            </div>
                 ...
                 <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                @include('configuration.categorieMedicament')
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>Liste des médicaments</header>
                                            <div class="tools">
                                        ...
                                        <form action="{{ route('search') }}" method="POST">
                                            @csrf
                                            <input type="text" name="search" placeholder="Rechercher un medicament" style="margin-left: 20px; margin-right: 20px; margin-top: 10px; padding-left: 10px;">
                                        </form>
                                        <div class="card-body ">
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($medicaments as $key => $medicament)
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td >{{ $medicament->mdesc }}</td>
                                                        <td >{{ $medicament->catdesc }}</td>
                                                        <td>
