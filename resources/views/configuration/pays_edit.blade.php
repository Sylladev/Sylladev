          ...
          <div class="row">
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Modifier le pays</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('update_pays',$pays[0]->idPays) }}">
                                            {{ csrf_field() }}

                             
                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Nom du pays</label>
                                              <input type="text" value="{{$pays[0]->nomPays}}" name="nomPays" required class="form-control">
                                            </div>
