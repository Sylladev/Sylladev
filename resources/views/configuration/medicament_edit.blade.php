          ...
          <div class="row">
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Modifier le medicament</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('update_medicament',$medoc[0]->idMedicament) }}">
                                            {{ csrf_field() }}

                             
                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Nom du medicament</label>
                                              <input type="text" value="{{$medoc[0]->description}}" name="description" required class="form-control">
                                            </div>
