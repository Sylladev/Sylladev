             ...
             <div class="row">
                   <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Type examen</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_examen') }}">
                                            {{ csrf_field() }}
                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Type</label>
                                              <input type="text" name="typeExamens" required class="form-control">
                                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>Liste des examens</header>
                                            <div class="tools">
                                            ...
                                            <table class="table table-striped custom-table table-hover">
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($examens as $key => $examen)
                                                   ...
                                                   <tr>
                                                        <td>{{ $key+1 }}</td>
                                                        <td >{{ $examen->typeExamens }}</td>
                                                        <td >{{ $examen->description }}</td>
                                                        <td>
                                                            <a href="{{ route('edit_examen',[$examen->idTypeExamens])}}" class="btn btn-primary btn-xs bouton">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <center>
                                                                              ...
                                                                              <div class="modal-footer">
                                                                                <a href="{{route('delete_examen',[$examen->idTypeExamens])}}" class="btn btn-danger bouton" >Oui</a>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
