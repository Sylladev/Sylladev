          ...
          <div class="row">
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Modifier le type d'examen</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('update_examen',$examens[0]->idTypeExamens) }}">
                                            {{ csrf_field() }}

                                             <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Type</label>
                                              <input type="text" value="{{$examens[0]->typeExamens}}" name="typeExamens" required class="form-control">
                                            </div>
                             
                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Description</label>
                                              <input type="text" value="{{$examens[0]->description}}" name="description" required class="form-control">
                                            </div>
