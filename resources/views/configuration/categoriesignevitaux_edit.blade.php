              ...
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{route('update_categoriesignevitaux', $categoriesignevitaux[0]->idCatSV)}}">
                                            @csrf  
                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Description</label>
                                              <input type="text" name="description" value="{{$categoriesignevitaux[0]->description}}" required class="form-control">
                                            </div>
