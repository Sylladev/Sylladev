          ...
          <div class="row">
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Nouveau Departement</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_departement') }}">
                                            {{ csrf_field() }}
                                            ...
                                            <input type="hidden" name="idHopital" value="H01">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>Liste des Departements</header>
                                            <div class="tools">
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($departements as $key => $departement)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit_departement',[$departement->idDepartement])}}" class="btn btn-primary btn-xs bouton">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <center>
                                                                              ...
                                                                              <div class="modal-footer">
                                                                                <a href="{{ route('delete_departement',[$departement->idDepartement]) }}" class="btn btn-danger bouton" >Oui</a>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
