             ...
             <div class="row">
                   <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Nouveau type de vaccin</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_vaccination') }}">
                                            {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>Liste des Types de vaccination</header>
                                            <div class="tools">
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($vaccinations as $key => $vaccination)
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit_vaccination',[$vaccination->idTypeVaccination])}}" class="btn btn-primary btn-xs bouton">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <center>
                                                                              ...
                                                                              <div class="modal-footer">
                                                                                <a href="{{route('delete_vaccination',[$vaccination->idTypeVaccination])}}" class="btn btn-danger bouton" >Oui</a>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
