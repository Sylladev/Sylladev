          ...
          <div class="row">
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Nouvelle Specialité</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_specialite') }}">
                                            {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>Liste des Specialités</header>
                                            <div class="tools">
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($specialites as $key => $specialite)
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit_specialite',[$specialite->idSpecialite])}}" class="btn btn-primary btn-xs bouton">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <center>
                                                                              ...
                                                                              <div class="modal-footer">
                                                                                <a href="{{route('delete_specialite',[$specialite->idSpecialite])}}" class="btn btn-danger bouton" >Oui</a>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
