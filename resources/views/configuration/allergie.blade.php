          ...
          <div class="row">
              <div class="col-md-12 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Nouvelle Allergie</header>
                                  
                                </div>
                                <div class="card-body " id="bar-parent">
                                    <form  method="POST" action="{{ route('create_allergie') }}">
                                            {{ csrf_field() }}
                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-2 form-group">
                                              <label for="simpleFormEmail">Type d'allergie</label>
                                               <select  class="form-control select @error('name') is-invalid @enderror" type="text" name="type" required autocomplete="name" autofocus>
                                                        ...
                                                        <option value="drug">Medicaments</option>  
                                                 </select>
                                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>Liste des Allergies</header>
                                            <div class="tools">
                                                ...
                                                <tbody>
                                                 ...
                                                 @foreach($allergies as $key => $allergie)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit_allergie',[$allergie->idAllergie])}}" class="btn btn-primary btn-xs bouton">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <center>
                                                                              ...
                                                                              <div class="modal-footer">
                                                                                <a href="{{ route('delete_allergie',[$allergie->idAllergie]) }}" class="btn btn-danger bouton" >Oui</a>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
