...
<div class="row h-100">
    <div class="col-lg-6 col-12">
        <div id="auth-left">
            ...
            <h2 class="auth-title"><i class="bi bi-repeat"></i>  Reinitialiser  votre mot de passe</h2>
            <p class="auth-subtitle mb-5">Entrez votre adresse mail.</p>

            <form action="{{route('confirmEmail')}}" method="POST">
                 @csrf
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="email" class="form-control form-control-xl"  name="email" value="{{ old('email') }}" placeholder="Email" required>
                ...
                <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="">Continuer</button>
            </form>
